...
ALTER TABLE `Users` ADD UNIQUE KEY `user_email_unique` (`email`);
...
ALTER TABLE `Property` ADD INDEX `property_location_index` (`location`);
...
-- FOREIGN KEYS
ALTER TABLE `Payment` 
    ADD CONSTRAINT `payment_payment_method_foreign` 
    FOREIGN KEY (`payment_method`) REFERENCES `PaymentMethod`(`method_id`);

ALTER TABLE `Payment` 
    ADD CONSTRAINT `payment_booking_id_foreign` 
    FOREIGN KEY (`booking_id`) REFERENCES `Booking`(`booking_id`);

ALTER TABLE `Booking` 
    ADD CONSTRAINT `booking_user_id_foreign` 
    FOREIGN KEY (`user_id`) REFERENCES `Users`(`user_id`);

ALTER TABLE `Booking` 
    ADD CONSTRAINT `booking_property_id_foreign` 
    FOREIGN KEY (`property_id`) REFERENCES `Property`(`property_id`);

ALTER TABLE `Review` 
    ADD CONSTRAINT `review_user_id_foreign` 
    FOREIGN KEY (`user_id`) REFERENCES `Users`(`user_id`);

ALTER TABLE `Review` 
    ADD CONSTRAINT `review_property_id_foreign` 
    FOREIGN KEY (`property_id`) REFERENCES `Property`(`property_id`);

ALTER TABLE `Message` 
    ADD CONSTRAINT `message_sender_id_foreign` 
    FOREIGN KEY (`sender_id`) REFERENCES `Users`(`user_id`);

ALTER TABLE `Message` 
    ADD CONSTRAINT `message_recipient_id_foreign` 
    FOREIGN KEY (`recipient_id`) REFERENCES `Users`(`user_id`);

ALTER TABLE `Property` 
    ADD CONSTRAINT `property_host_id_foreign` 
    FOREIGN KEY (`host_id`) REFERENCES `Users`(`user_id`);

ALTER TABLE `Property` 
    ADD CONSTRAINT `property_location_foreign` 
